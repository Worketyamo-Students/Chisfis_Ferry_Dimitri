...
const PasswordBoxForm = () => {
  return (
    <div>
        ...
        <Link to={'#'}>
        <h2 className="text-[1.7rem] dark:text-white text-gray-500 underline hover:text-blue-700 duration-300 dark:hover:text-blue-700 dark:hover:duration-700">Forgot password?</h2>
        </Link>
        </div>
